...
public class YandexMarketCatalogTest {

    protected static WebDriver driver;
    private Logger logger = LogManager.getLogger(YandexMarketCatalogTest.class);
    ...
    public void test() {
        ...
        logger.info("Выбрана сортировка по цене(от меньшей к большей)");
        new WebDriverWait(driver, 60)
